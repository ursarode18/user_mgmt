<aside id="sidebar" class="sidebar w3-teal" ">
    ...
    {{--<li class="nav-heading"><p><b>All Division Details</b></p></li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#user-act-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>User Setting</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
